...
_runtime_config = load_config(require_api=True)

API_KEY    = _runtime_config.api_key
API_SECRET = _runtime_config.api_secret

SPOT_BASE    = _runtime_config.spot_base
FUTURES_BASE = _runtime_config.futures_base

# ── Paths ────────────────────────────────────────────────────────────────────
BASE_DIR     = os.path.dirname(os.path.abspath(__file__))
STATE_FILE   = _runtime_config.state_file
TRADES_LOG   = _runtime_config.trades_log
ANALYSIS_LOG = _runtime_config.analysis_log
LOCK_FILE    = _runtime_config.lock_file

# ── Alertas ──────────────────────────────────────────────────────────────────
ALERT_TARGET = _runtime_config.alert_target
