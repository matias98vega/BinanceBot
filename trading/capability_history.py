...
def _capability(capability_id, name, status, introduced_at, commit, behavioral=False,
    ...
    return {
        ...
        'affects_execution': bool(effects.get('affects_execution')),
...
CAPABILITIES = (
    ...
    _capability('partial-quantity-integrity-v1', 'Exact partial close quantity integrity', 'DEPLOYED',
                '2026-07-25T00:00:00Z', 'fa759ad', True, ('v1.3-partial-quantity-fix',),
                predecessor='sizing-v2', affects_trade_management=True, affects_observability=True,
                notes='Remaining equals normalized initial minus confirmed executedQty; no historical backfill.'),
    _capability('spot-market-status-guard-v1', 'Spot market status entry guard', 'ACTIVE',
                '2026-08-17T23:57:36Z', '7f3c8dcffdeb699a913b6324159b88a081b04d22', True,
                ('v1.4-spot-market-status-guard',), predecessor='partial-quantity-integrity-v1',
                affects_execution=True, affects_observability=True,
                notes='Blocks non-TRADING Spot Long execution; does not alter strategic candidate selection.'),
    _capability('preventive-futures-close-confirmation-v1',
                'Confirmed preventive Futures SHORT close', 'IMPLEMENTED',
                '2026-08-19T17:16:32Z', '7b181a17be705febb6b0a4d941a51ff356b609c0', True,
                ('v1.5-preventive-futures-close-fix',), predecessor='spot-market-status-guard-v1',
                affects_execution=True, affects_trade_management=True, affects_observability=True,
                notes='Preventive SHORT Futures uses real reduce-only MARKET execution and exchange-flat confirmation before local close; LONG Spot is not covered.'),
    _capability('preventive-spot-close-confirmation-v1',
                'Confirmed preventive Spot LONG close', 'IMPLEMENTED',
                '2026-08-28T00:41:08Z', '8e79c537ecc2e66a532d4ecbb86559f84c989391', True,
                ('v1.6-preventive-spot-close-fix',),
                predecessor='preventive-futures-close-confirmation-v1',
                affects_execution=True, affects_trade_management=True, affects_observability=True,
                notes='Preventive LONG Spot closes only after confirmed MARKET SELL execution and fresh balance evidence; SHORT Futures behavior is unchanged and historical records are not backfilled.'),
    _capability('partial-spot-quantity-safety-v1',
                'Managed Spot LONG partial quantity safety', 'IMPLEMENTED',
                '2026-09-21T19:55:00Z', '140eb12631fc3b5381b4b44b7989f75e5b4ef3ba', True,
    ...
    _capability('spot-quantity-serialization-v1',
                'Canonical Spot quantity serialization', 'IMPLEMENTED',
                '2026-09-22T17:45:00Z', 'eeadd0a2ccdb064f34df202acf67a7b64a37895b', True,
                ('v1.7-partial-spot-quantity-safety',),
                predecessor='partial-spot-quantity-safety-v1',
                affects_execution=True, affects_trade_management=True, affects_observability=True,
                notes='Every productive Spot quantity boundary uses step-normalized fixed-point serialization for entry BUY, OCO, MARKET SELL, Guardian, preventive close, partial and recovery. Strategy, sizing, TP/SL, SHORT, Guardian thresholds and recovery ownership are unchanged.'),
