...
El diseño opt-in para históricos multi-shard y manifests está documentado en [`docs/ARCHIVE_MANIFEST.md`](docs/ARCHIVE_MANIFEST.md); no hay rotación nueva activa.
