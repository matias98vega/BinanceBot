...
| Ítem | Estado | Evidencia | Pendiente real | Dependencia | Prioridad |
|---|---|---|---|---|---|
| Auditoría unificada state-vs-exchange pre-entry | PARCIAL | gate AUDIT_ONLY, evidencia durable schema 1, shadow v1 y `preentry-tolerance-shadow-v2` aditivo/read-only | Observar v2 al menos 28 días y 300 casos completos, balancear LONG/SHORT y revisar fronteras; ENFORCE sigue en tarea separada | Evidencia productiva sin falsos seguros materiales | Alta |
